# Fold Club - SEO Strategy

## Executive Summary

Based on DataForSEO analysis of the Polish papercraft market, this strategy focuses on leveraging **seasonal spikes** (carnival season Feb/Jan), **low-competition technical terms** (papercraft, low poly), and **gift/decoration use cases** to capture organic traffic.
...
- **Wall art positioning**: "ozdoba na ścianę" (nowekartonowe focuses on education)

---

## 2. SEO-Optimized Information Architecture
...
foldclub.pl/
├── / (Homepage)
│   Meta: "Papercraft Low Poly - Geometryczne Maski Zwierząt | Fold Club"
│   H1: "Maski Papercraft Low Poly - Kreatywne Zestawy DIY"
│
├── /sklep (Shop - main category hub)
│   Meta: "Sklep z Zestawami Papercraft - Maski Low Poly i Dekoracje 3D"
│   H1: "Zestawy Papercraft - Low Poly Maski Zwierząt"
│
├── /sklep/maski-dla-par (Couples category)
│   Meta: "Maski Papercraft dla Par - Kreatywny Prezent na Walentynki"
│   H1: "Maski Low Poly dla Zakochanych"
│
├── /sklep/maski-dla-dzieci (Kids category)
│   Meta: "Maski Zwierząt z Papieru dla Dzieci - DIY Dinozaur"
│   H1: "Papierowe Maski Zwierząt dla Dzieci"
│
├── /sklep/maski-karnawałowe (NEW - Carnival landing page)
│   Meta: "Maski Karnawałowe DIY - Geometryczne Zwierzęta z Papieru"
│   H1: "Maski Karnawałowe Papercraft - Wyróżnij Się na Balu!"
│   Content: Targets Feb/Jan spike, links to cat, fox, sphinx cat products
│
├── /sklep/ozdoby-scienne (NEW - Wall decoration landing page)
│   Meta: "Ozdoby Ścienne 3D z Papieru - Low Poly Zwierzęta"
│   H1: "Geometryczne Ozdoby Ścienne - Dekoracje 3D z Papieru"
│   Content: Target "ozdoba na ścianę" (6,600 SV), showcase all products as decor
│
├── /sklep/prezenty-diy (NEW - Gift landing page)
│   Meta: "Kreatywny Prezent DIY - Zestawy Papercraft Low Poly"
│   H1: "Prezent dla Chłopaka/Dziewczyny - Zrób To Sam"
│   Content: Gift guides, couple's activity angle
│
├── /galeria (Gallery)
│   Meta: "Galeria Realizacji - Zobacz Efekty Papercraft Low Poly"
│   H1: "Twoje Kreacje - Galeria Fold Club"
│
├── /faq
├── /wysylka
├── /kontakt
└── /blog (NEW - Content hub for long-tail)
    ├── /blog/jak-zrobic-maske-z-papieru
    ├── /blog/maski-karnawałowe-diy-poradnik
    └── /blog/low-poly-co-to-jest
```
...
**Primary Keywords**: papercraft, low poly, maski zwierząt
...
<section class="seo-content">
  ...
  <h3>Zastosowania:</h3>
  <ul>
    <li>Maski karnawałowe DIY - wyróżnij się na balu</li>
    <li>Ozdoby ścienne 3D - nowoczesna dekoracja salonu</li>
    <li>Kreatywny prezent dla chłopaka/dziewczyny</li>
    <li>Aktywność dla par - randka DIY</li>
  </ul>
</section>
```
...
export async function GET() {
  ...
  const staticPages = [
    ...
    { url: 'shop/maski-karnawałowe', priority: 0.8, changefreq: 'weekly' },
    { url: 'shop/ozdoby-scienne', priority: 0.8, changefreq: 'weekly' },
    { url: 'shop/prezenty-diy', priority: 0.7, changefreq: 'weekly' },
...
<svelte:head>
  ...
  <meta property="og:site_name" content="Fold Club" />
...
<svelte:head>
  {@html `
    <script type="application/ld+json">
    {
      ...
      "@type": "Organization",
      "name": "Fold Club",
      "url": "https://foldclub.pl",
      "logo": "https://foldclub.pl/logo.png",
      "description": "Zestawy papercraft low poly do składania geometrycznych masek zwierząt",
      "address": {
        "@type": "PostalAddress",
        "addressCountry": "PL"
      }
...
```json
{
  "@context": "https://schema.org",
  "@type": "Product",
  "name": "Maska Kota Low Poly - Papercraft DIY",
  "description": "Zestaw papercraft do składania geometrycznej maski kota",
  "image": "https://foldclub.pl/products/cat-mask.jpg",
  "offers": {
    "@type": "Offer",
    "price": "69.00",
    "priceCurrency": "PLN",
...
### Blog Post Ideas (Target Long-Tail)

1. **"Jak Zrobić Maskę z Papieru? Poradnik Papercraft dla Początkujących"**
   - Target: "jak zrobić maskę z papieru", "papercraft tutorial"
   - Content: Step-by-step guide, link to products

2. **"Maski Karnawałowe DIY - 5 Pomysłów na Bal Przebierańców"**
   - Target: "maski karnawałowe diy", "pomysły na karnawał"
   - Publish: December (before Jan/Feb spike)

3. **"Low Poly - Co To Jest? Sztuka Geometrycznych Form w Papercrafcie"**
   - Target: "low poly co to", "geometryczne zwierzęta"
   - Educational content for brand authority

4. **"Kreatywny Prezent dla Chłopaka - DIY Zamiast Sklepu"**
   - Target: "prezent dla chłopaka diy", "kreatywny prezent"
   - Publish: November (before December gift season)

5. **"Ozdoby Ścienne 3D z Papieru - Nowoczesna Dekoracja Salonu"**
   - Target: "ozdoby ścienne 3d", "dekoracje do salonu"
...
- 50+ backlinks from Polish craft/DIY sites

---

## Next Steps

1. Implement technical SEO (robots.txt, sitemap, meta tags)
2. Create 3 new landing pages (carnival, wall decor, gifts)
3. Add SEO content to homepage
4. Set up Google Search Console
5. Plan content calendar for blog
