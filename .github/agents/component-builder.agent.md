...
<div class="brutal-card paper-shadow-md">
  ...
  {#if description}
    <p class="body mt-2 text-ink-muted">{description}</p>
  {/if}
</div>
```
...
<article class="brutal-card paper-press">
  ...
  <p class="body-small mt-1 text-ink-muted">{description}</p>
...
<div class="rounded-lg shadow-lg transition-all duration-300 hover:scale-105">
  ...
  <button class="rounded-md bg-blue-500 transition-colors hover:bg-blue-600"> Click me </button>
</div>

<!-- ✅ CORRECT - Brutalist design -->
<div class="brutal-card paper-shadow-md">
  <h2 class="heading-2">HEADING</h2>
  <button class="btn btn-primary paper-press"> CLICK ME </button>
</div>
```
